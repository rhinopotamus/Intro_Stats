...
This is the key to interpreting confidence intervals. The "95%" in a 95% confidence interval means that if we were to collect many random samples, and then make a confidence interval from each one, about 95% of those confidence intervals would contain the true population parameter and about 5% would not.
